package com.example.busafcs.advice;
...
import com.example.busafcs.bean.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 */
	  @ExceptionHandler(ExpiredJwtException.class)
	     public ResponseEntity<?> globleExcpetionHandler(ExpiredJwtException ex, WebRequest request) {
