...
public class UserEntityDAOImpl implements UserEntityDAO {
	...
	public DriverConductorEntity findByEmpId(String empId) {
		...
		try {
			TypedQuery<DriverConductorEntity> query = entityManager.createNamedQuery("DriverConductorEntity.findByEmpId",	DriverConductorEntity.class);
			query.setParameter("employeeId", empId);
			driverConductorEntity = query.getSingleResult();
		} catch (Exception ex) {
			//throw ex;
			return driverConductorEntity;
		}
	...
	public DriverConductorEntity findByDrivCondMobile(String mobile) {
		DriverConductorEntity driverConductorEntity = null;
		try {
			TypedQuery<DriverConductorEntity> query = entityManager.createNamedQuery("DriverConductorEntity.findByMobile",	DriverConductorEntity.class);
			query.setParameter("mobile", mobile);
			driverConductorEntity = query.getSingleResult();
		} catch (Exception ex) {
			//throw ex;
